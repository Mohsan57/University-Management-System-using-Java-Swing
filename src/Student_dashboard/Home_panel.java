   ...
   Color background_color;
    ...
    Home_panel(int student_id) {
        ...
        try {
            ...
            Logger.getLogger(Teacher_dashboard.Home_panel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void get_teacher_detail(){
        try {
            String query="select * from student_detail("+this.student_id+")";
